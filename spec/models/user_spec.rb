...
describe User do
  ...
  describe "email validations" do  
    ...
    it "should reject invalid email addreses" do
      addresses = %w[uuser@foo,com user_at_foo.org example.user@foo.]
      addresses.each do |address|
  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      it "should return nil on email/pw mismatch" do
        wrong_pw_user = User.authenticate(@attr[:email], "wrong_pw")
      ...
      it "should return the user on email/pw patch" do
